...
import { Container, Table, Card, Badge, Spinner, Alert, Tabs, Tab, Row, Col } from 'react-bootstrap';
import axios from 'axios';
import { useNavigate } from 'react-router-dom';
import { FaUsers, FaUserCircle, FaEnvelope, FaPhone, FaHeadset, FaCommentAlt, FaClock, FaSignOutAlt, FaPlane, FaHotel, FaTrain, FaBus } from 'react-icons/fa';
                ...
                <td className="py-4 pe-4" style={{ maxWidth: '500px' }}>
                    <div className="text-muted small text-truncate-2" title={contact.message}>
                        {contact.message}
                                            ...
                                            <tr>
                                                <td colSpan="2" className="text-center py-5 text-muted">No contact inquiries found.</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </Table>
